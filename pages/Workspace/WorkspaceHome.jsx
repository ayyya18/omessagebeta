            ...
            sidebar={
                <div className="chat-sidebar-column">
                    <div className="sidebar-header">
                        <h3>My Workspaces</h3>
                        <button className="glass-btn icon-only" onClick={() => setShowCreateModal(true)} title="Create Workspace"><FiPlus /></button>
                    </div>
                        ...
                        <>
                            ...
                            {currentWorkspace ? (
                                <div className="workspace-content-area" style={{ padding: 32 }}>
                                    ...
                                    {activeTab === 'overview' && (
                                        <div className="workspace-grid-layout" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 320px', gap: 40 }}>
                                            {/* Main Dashboard */}
